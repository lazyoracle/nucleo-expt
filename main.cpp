...
using drivers::synth_hd::Synth_HD;
...
//Initialise SynthHD Serial Comm with fixed 115200 baud rate
//Use unused AD9959_MISO as the unused Rx port for serial comm
RawSerial SynthHD_1(Pin_SynthHD_1, Pin_AD9959_MISO, 115200); //For 3GHz EOM and Antenna
RawSerial SynthHD_2(Pin_SynthHD_2, Pin_AD9959_MISO, 115200); //For 6.8GHz EOM and Antenna
...
int main()
{
    while (true) 
    {
            ...
            ANT_1_Chirp_Freq_STATE_PREP = ANT_1_Chirp_Freq_STATE_PREP_vals[run_count];
            ...
            ANT_2_Chirp_Freq_STATE_PREP = ANT_2_Chirp_Freq_STATE_PREP_vals[run_count];
            ...
            EOM_1_Chirp_Freq_RAMAN = EOM_1_Chirp_Freq_RAMAN_vals[run_count];
            ...
            EOM_2_Chirp_Freq_RAMAN = EOM_2_Chirp_Freq_RAMAN_vals[run_count];
        ...
        int SynthHD_1_settings[] = {EOM_1_Freq_Init, ANT_1_Freq_Init, EOM_1_Pow_Init, ANT_1_Pow_Init, 
                                    EOM_1_Chirp_Freq_RAMAN, ANT_1_Chirp_Freq_STATE_PREP,
                                    EOM_1_Freq_Start_RAMAN, EOM_1_Freq_End_RAMAN,
                                    ANT_1_Freq_Start_STATE_PREP, ANT_1_Freq_End_STATE_PREP};
        microwave.SynthHD_config(SynthHD_1, SynthHD_1_settings);
        MOTC = 0;
        ...
        MOTC = 1;
        microwave.SynthHD_chirp_control(SynthHD_1, 1, 1); //Start Antenna Chirp on Channel 1 in SynthHD_1
        wait_us(5000);
        microwave.SynthHD_chirp_control(SynthHD_1, 1, 0); //End Antenna Chirp on Channel 1 in SynthHD_1
        wait_us(STATE_PREP);
        ...
        MOTC = 0;
        //Set EOM freq to centre because chirp goes +/- deviation
        microwave.SynthHD_set_freq(SynthHD_1, 0, EOM_1_Freq_Start_RAMAN + (EOM_1_Freq_End_RAMAN - EOM_1_Freq_Start_RAMAN)/2.0); 
        microwave.SynthHD_chirp_control(SynthHD_1, 0, 1); //Start EOM Chirp on Channel 1 in SynthHD_1
        wait_us(5000);
        microwave.SynthHD_chirp_control(SynthHD_1, 0, 0); //End EOM Chirp on Channel 1 in SynthHD_1
        wait_us(RAMAN);
